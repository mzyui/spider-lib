...
use spider_util::constants::{
    MIDDLEWARE_CACHE_CAPACITY, MIDDLEWARE_CACHE_TTL_SECS, RATE_LIMIT_INITIAL_DELAY_MS,
...
const INITIAL_DELAY: Duration = Duration::from_millis(RATE_LIMIT_INITIAL_DELAY_MS);
const MIN_DELAY: Duration = Duration::from_millis(RATE_LIMIT_MIN_DELAY_MS);
const MAX_DELAY: Duration = Duration::from_millis(RATE_LIMIT_MAX_DELAY_MS);
...
impl AdaptiveLimiter {
    ...
    fn apply_jitter(&self, delay: Duration) -> Duration {
        ...
        let max_jitter = Duration::from_millis(RATE_LIMIT_MAX_JITTER_MS);
